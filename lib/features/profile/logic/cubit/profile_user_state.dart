...
class ProfileUserState with _$ProfileUserState {
  ...
  const factory ProfileUserState.success(
      {required ProfileUserModel profileUserMode}) = Success;
  ...
  const factory ProfileUserState.successUpdate(
      {required ProfileUserModel profileUserMode}) = SuccessUpdate;
  const factory ProfileUserState.errorUpdste({required String error}) =
      ErrorUpdate;
  // const factory ProfileUserState.pickImage() = PickImage;
}
